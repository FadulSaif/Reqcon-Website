              ...
              >
                ...
                <div className="cp-office-details">
                  ...
                  <div className="cp-office-row">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@agil.se" className="cp-office-detail-value cp-office-link">
                        info@agil.se
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="cp-office-row">
                    ...
                    <div>
                      ...
                      <a href="tel:+4681234567" className="cp-office-detail-value cp-office-link">
                        +46 8 123 4567
                      </a>
                    </div>
                  </div>
                ...
                <div className="cp-office-socials">
                  ...
                  <div className="cp-office-social-row">
                    <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="cp-office-social-link">
                      <Linkedin size={18} />
                      LinkedIn
                    </a>
                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="cp-office-social-link">
                      <Facebook size={18} />
                      Facebook
                    </a>
                  </div>
