        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-nav-list">
              <a href="mailto:info@agilarbetskraft.se" className="footer-link contact-link">
                ...
                <span>info@agilarbetskraft.se</span>
              </a>
              <a href="tel:+4600000000" className="footer-link contact-link">
                <div className="contact-icon-wrapper"><Phone size={16} /></div>
                <span>+46 00 000 000</span>
              </a>
            </div>
          </div>
          ...
          <div className="footer-col">
            ...
            <div className="footer-socials-flat">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="social-link-flat">
                <Facebook size={20} />
                <span>Facebook</span>
              </a>
            </div>
