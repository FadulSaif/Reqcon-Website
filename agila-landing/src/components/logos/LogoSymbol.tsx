// Agil Symbol Only – standalone mark, colored orange gradient
export default function LogoSymbol({ className = "", style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg
    ...
    >
      ...
      <path className="ls-1" d="M21.8866,81.9743l2.65-5.9142h13.7884l4.1305-9.2183h-13.7884l11.4306-25.5108h.5964l9.2547,20.654,5.051-11.2725-8.3342-18.5999h-12.5394l-17.6699,39.4352c-1.916-5.1573-2.9672-10.7315-2.9672-16.5475C13.4892,28.7228,34.868,7.344,61.1455,7.344c12.6995,0,24.2457,5.0032,32.7967,13.1298C84.5125,10.0576,70.8923,3.5027,55.7682,3.5027,27.3721,3.5027,4.2709,26.6039,4.2709,55s23.1013,51.4973,51.4973,51.4973c15.1221,0,28.7408-6.5531,38.1703-16.9668-8.5506,8.1245-20.0951,13.1262-32.7929,13.1262-16.2708,0-30.6568-8.2016-39.259-20.6825Z"/>
    </svg>
  );
}
